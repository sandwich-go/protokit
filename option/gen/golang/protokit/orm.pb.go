...
type OrmMessageOptions struct {
	...
	Bean bool `protobuf:"varint,5,opt,name=bean,proto3" json:"bean,omitempty"`
...
type OrmFieldOptions struct {
	...
	// 是否是 job category 字段
	JobCategory bool `protobuf:"varint,26,opt,name=job_category,json=jobCategory,proto3" json:"job_category,omitempty"`
	// 是否是 job raw data 字段
	JobRawData bool `protobuf:"varint,27,opt,name=job_raw_data,json=jobRawData,proto3" json:"job_raw_data,omitempty"`
	// 别名
	Alias *Alias `protobuf:"bytes,28,opt,name=alias,proto3" json:"alias,omitempty"`
}
...
func (x *OrmFieldOptions) GetJobCategory() bool {
	if x != nil {
...
func (x *OrmFieldOptions) GetJobRawData() bool {
	if x != nil {
		return x.JobRawData
	}
	return false
...
func (x *OrmFieldOptions) GetAlias() *Alias {
	if x != nil {
		return x.Alias
	}
	return nil
...
func (x *Alias) GetPackageAlias() string {
	if x != nil {
...
func (x *Alias) GetPackagePath() string {
	if x != nil {
...
var file_protokit_orm_proto_rawDesc = []byte{
	...
	0x22, 0xea, 0x07, 0x0a, 0x0f, 0x4f, 0x72, 0x6d, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x4f, 0x70, 0x74,
	...
	,
	...
	0x6d, 0x65, 0x22, 0x4e, 0x0a, 0x04, 0x4c, 0x6f, 0x63, 0x6b, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	...
	0x6e, 0x74, 0x22, 0x5d, 0x0a, 0x08, 0x53, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x16,
	...
	0x6c, 0x65, 0x22, 0x4d, 0x0a, 0x05, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x18, 0x0a, 0x07, 0x64,
	...
	0x64, 0x42, 0x4b, 0x5a, 0x3a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
	...
	0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x6b, 0x69, 0x74, 0xaa,
	0x02, 0x0c, 0x67, 0x65, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x6b, 0x69, 0x74, 0x62, 0x06,
...
var file_protokit_orm_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_protokit_orm_proto_goTypes = []interface{}{
	...
	(*Alias)(nil),                       // 7: protokit.Alias
	(*Lock)(nil),                        // 8: protokit.Lock
	(*Sequence)(nil),                    // 9: protokit.Sequence
	(*Blob)(nil),                        // 10: protokit.Blob
	(*Int)(nil),                         // 11: protokit.Int
	(*Decimal)(nil),                     // 12: protokit.Decimal
	(*Index)(nil),                       // 13: protokit.Index
	(*Hint)(nil),                        // 14: protokit.Hint
...
var file_protokit_orm_proto_depIdxs = []int32{
	14, // 0: protokit.OrmMessageOptions.hint:type_name -> protokit.Hint
	8,  // 1: protokit.OrmMessageOptions.lock:type_name -> protokit.Lock
	10, // 2: protokit.OrmFieldOptions.blob:type_name -> protokit.Blob
	2,  // 3: protokit.OrmFieldOptions.text:type_name -> protokit.TextSize
	13, // 4: protokit.OrmFieldOptions.unique:type_name -> protokit.Index
	13, // 5: protokit.OrmFieldOptions.index:type_name -> protokit.Index
	13, // 6: protokit.OrmFieldOptions.aggregate:type_name -> protokit.Index
	14, // 7: protokit.OrmFieldOptions.hint:type_name -> protokit.Hint
	14, // 8: protokit.OrmFieldOptions.shard:type_name -> protokit.Hint
	11, // 9: protokit.OrmFieldOptions.int:type_name -> protokit.Int
	12, // 10: protokit.OrmFieldOptions.decimal:type_name -> protokit.Decimal
	4,  // 11: protokit.OrmFieldOptions.compress:type_name -> protokit.Compress
	9,  // 12: protokit.OrmFieldOptions.sequence:type_name -> protokit.Sequence
	7,  // 13: protokit.OrmFieldOptions.alias:type_name -> protokit.Alias
	0,  // 14: protokit.Blob.blob_size:type_name -> protokit.BlobSize
	1,  // 15: protokit.Blob.blob_codec:type_name -> protokit.BlobCodec
	3,  // 16: protokit.Int.int_size:type_name -> protokit.IntSize
	15, // 17: protokit.orm_message:extendee -> google.protobuf.MessageOptions
	16, // 18: protokit.orm_field:extendee -> google.protobuf.FieldOptions
	5,  // 19: protokit.orm_message:type_name -> protokit.OrmMessageOptions
	6,  // 20: protokit.orm_field:type_name -> protokit.OrmFieldOptions
