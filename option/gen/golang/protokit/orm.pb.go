...
var file_protokit_orm_proto_rawDesc = []byte{
	...
	0x22, 0xb4, 0x02, 0x0a, 0x11, 0x4f, 0x72, 0x6d, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x4f,
	...
	0x09, 0x52, 0x06, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x12, 0x22, 0x0a, 0x04, 0x62, 0x65, 0x61,
	0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x6b,
	0x69, 0x74, 0x2e, 0x42, 0x65, 0x61, 0x6e, 0x52, 0x04, 0x62, 0x65, 0x61, 0x6e, 0x12, 0x22, 0x0a,
	...
	0x12, 0x15, 0x0a, 0x06, 0x6e, 0x6f, 0x5f, 0x6c, 0x6f, 0x67, 0x18, 0x1c, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x05, 0x6e, 0x6f, 0x4c, 0x6f, 0x67, 0x22, 0xda, 0x07, 0x0a, 0x0f, 0x4f, 0x72, 0x6d, 0x46,
	...
	0x65, 0x52, 0x04, 0x74, 0x65, 0x78, 0x74, 0x12, 0x27, 0x0a, 0x06, 0x75, 0x6e, 0x69, 0x71, 0x75,
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x6b,
	0x69, 0x74, 0x2e, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x52, 0x06, 0x75, 0x6e, 0x69, 0x71, 0x75, 0x65,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x64, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x12, 0x15, 0x0a,
	0x06, 0x6e, 0x6f, 0x5f, 0x6c, 0x6f, 0x67, 0x18, 0x1c, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x6e,
	0x6f, 0x4c, 0x6f, 0x67, 0x22, 0x53, 0x0a, 0x04, 0x42, 0x65, 0x61, 0x6e, 0x12, 0x10, 0x0a, 0x03,
	...
	0x4e, 0x0a, 0x04, 0x4c, 0x6f, 0x63, 0x6b, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	...
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x52, 0x08, 0x6f, 0x72, 0x6d, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x42, 0x4b,
...
var file_protokit_orm_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_protokit_orm_proto_goTypes = []interface{}{
	...
	(*Bean)(nil),                        // 7: protokit.Bean
	(*GoType)(nil),                      // 8: protokit.GoType
	(*Lock)(nil),                        // 9: protokit.Lock
	(*Sequence)(nil),                    // 10: protokit.Sequence
	(*Blob)(nil),                        // 11: protokit.Blob
	(*Int)(nil),                         // 12: protokit.Int
	(*Decimal)(nil),                     // 13: protokit.Decimal
	(*Index)(nil),                       // 14: protokit.Index
	(*Hint)(nil),                        // 15: protokit.Hint
...
var file_protokit_orm_proto_depIdxs = []int32{
	7,  // 0: protokit.OrmMessageOptions.bean:type_name -> protokit.Bean
	15, // 1: protokit.OrmMessageOptions.hint:type_name -> protokit.Hint
	9,  // 2: protokit.OrmMessageOptions.lock:type_name -> protokit.Lock
	11, // 3: protokit.OrmFieldOptions.blob:type_name -> protokit.Blob
	2,  // 4: protokit.OrmFieldOptions.text:type_name -> protokit.TextSize
	14, // 5: protokit.OrmFieldOptions.unique:type_name -> protokit.Index
	14, // 6: protokit.OrmFieldOptions.index:type_name -> protokit.Index
	14, // 7: protokit.OrmFieldOptions.aggregate:type_name -> protokit.Index
	15, // 8: protokit.OrmFieldOptions.hint:type_name -> protokit.Hint
	15, // 9: protokit.OrmFieldOptions.shard:type_name -> protokit.Hint
	12, // 10: protokit.OrmFieldOptions.int:type_name -> protokit.Int
	13, // 11: protokit.OrmFieldOptions.decimal:type_name -> protokit.Decimal
	4,  // 12: protokit.OrmFieldOptions.compress:type_name -> protokit.Compress
	10, // 13: protokit.OrmFieldOptions.sequence:type_name -> protokit.Sequence
	8,  // 14: protokit.OrmFieldOptions.go_type:type_name -> protokit.GoType
	8,  // 15: protokit.Bean.dynamic_generic:type_name -> protokit.GoType
	...
	16, // 19: protokit.orm_message:extendee -> google.protobuf.MessageOptions
	17, // 20: protokit.orm_field:extendee -> google.protobuf.FieldOptions
	5,  // 21: protokit.orm_message:type_name -> protokit.OrmMessageOptions
	6,  // 22: protokit.orm_field:type_name -> protokit.OrmFieldOptions
