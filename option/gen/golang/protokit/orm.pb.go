...
type OrmFieldOptions struct {
	...
	// 生存时间，单位秒
	Ttl uint32 `protobuf:"varint,31,opt,name=ttl,proto3" json:"ttl,omitempty"`
}
...
func (x *OrmFieldOptions) GetTtl() uint32 {
	if x != nil {
		return x.Ttl
	}
	return 0
...
var file_protokit_orm_proto_rawDesc = []byte{
	...
	0x10, 0x0a, 0x03, 0x74, 0x74, 0x6c, 0x18, 0x1f, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x74, 0x74,
